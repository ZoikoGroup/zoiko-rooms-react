...
import { Landmark, KeyRound, Users, ShieldCheck } from "lucide-react";
...
const owners = [
  {
    icon: Landmark,
    title: "Public body / partner",
    description: "Owns program criteria, authority, and funding decisions.",
  },
  {
    icon: KeyRound,
    title: "Provider",
    description: "Owns exact room authority, accuracy, and maintenance.",
  },
  {
    icon: Users,
    title: "Participant",
    description: "Reviews, accepts or declines, and can escalate concerns.",
  },
  {
    icon: ShieldCheck,
    title: "Zoiko Rooms",
        ...
        <Reveal className="flex flex-col items-center gap-10">
          <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
            ...
            <Paragraph className="mx-auto">
              {t(
                "Public body, provider, participant, and Zoiko Rooms each carry distinct, named responsibilities — no responsibility vacuum."
              )}
            </Paragraph>
          </div>
