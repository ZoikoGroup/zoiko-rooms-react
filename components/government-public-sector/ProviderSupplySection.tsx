...
const rooms = [
  {
    price: "$780/mo",
    description: "Provider network · avail. now",
  ...
  {
    price: "$690/mo",
    description: "Public-sector distributed · avail. 1 Sep",
  ...
  {
    price: "$610/mo",
    description: "Temporary pathway · avail. now",
    badge: "Nominated / allocated",
    tone: "gray" as const,
    image: "/images/government-public-sector/pathway-temporary-accommodation.png",
  },
];

export function ProviderSupplySection() {
  const { t } = useLanguage();
      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-10">
          <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
            <Eyebrow>{t("Provider Supply")}</Eyebrow>
            <SectionTitle>{t("Approved rooms, evidence attached")}</SectionTitle>
            <Paragraph className="mx-auto">
              {t(
                "Every listing carries provider authority, current availability, and complete costs — labeled by exactly which framework it came through."
              )}
            </Paragraph>
          </div>
