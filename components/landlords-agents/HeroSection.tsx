        ...
        <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            <motion.h1 variants={fadeUp} className="font-heading text-4xl font-bold text-brand-navy sm:text-[34px]">
              List with clear ownership or current instruction — and keep authority, availability,
              costs, and responsibility visible.
            </motion.h1>
            <motion.p variants={fadeUp} className="max-w-lg text-[15px] leading-relaxed text-[#7A7266]">
              Choose whether you are the landlord or acting as an authorized agent. Zoiko Rooms
              will show the evidence, room information, commercial terms, and review stages
              required for that role.
            </motion.p>

            <motion.div variants={fadeUp} className="flex flex-col gap-3 sm:flex-row">
              <Button href="/list-a-room/start-a-listing" size="lg" variant="secondary">
                Start a Landlord or Agent Listing
              </Button>
          ...
          >
            <NaturalImage
              ...
              alt="A landlord family and an agent reviewing listing documents together"
            />
          </motion.div>
        </Reveal>
      </Container>
