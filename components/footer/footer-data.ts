...
export const footerColumns: FooterColumnData[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Universities", href: "/organizations/universities" },
      ...
      { label: "Public Sector", href: "/organizations/government-public-sector" },
    ],
  },
  {
    title: "Pro & Resources",
    links: [
      { label: "Zoiko Rooms Pro", href: "/pro/overview" },
      { label: "Compliance & Verification", href: "/pro/compliance-and-verification" },
      { label: "Integrations & API", href: "/pro/integration-api" },
