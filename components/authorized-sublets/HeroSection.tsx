      ...
      <Container>
        <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            <Eyebrow>Authorized Sublets</Eyebrow>
            <motion.h1 variants={fadeUp} className="font-heading text-4xl font-bold text-brand-navy sm:text-[34px]">
              Offer a room only within the permission, dates, price, and conditions you are
              authorized to use.
            </motion.h1>
            <motion.p variants={fadeUp} className="max-w-lg text-[15px] leading-relaxed text-[#7A7266]">
              Understand what evidence is required, how your primary agreement limits the listing,
              what seekers must see before commitment, and what happens if permission changes.
            </motion.p>
          ...
          >
            <NaturalImage
              ...
              alt="A host handing over keys to two room seekers on a sofa"
            />
          </motion.div>
        </Reveal>
        ...
        <Reveal className="mt-10 flex flex-col gap-4">
          ...
          <motion.div variants={fadeUp}>
            ...
            >
              Different arrangement? Choose another provider path
