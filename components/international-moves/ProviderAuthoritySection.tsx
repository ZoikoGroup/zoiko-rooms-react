      ...
      <Container>
        <Reveal className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <Eyebrow>Provider Authority and Remote Evaluation</Eyebrow>
            <SectionTitle>Confirm who is offering the room, and why they may do so</SectionTitle>
          </div>
          ...
          >
            <NaturalImage
              ...
              alt="A provider walking a room seeker through a remote video viewing"
            />
          </motion.div>

          <BulletList items={points} />

          <Callout label="Remote evidence is not a guarantee">
            A video call, recorded tour, Room Passport, identity check, document, or organization
            referral can reduce uncertainty. None alone proves current condition, legal right to
            let, suitability, personal safety, or move success.
          </Callout>
        </Reveal>
      </Container>
    </SectionDivider>
