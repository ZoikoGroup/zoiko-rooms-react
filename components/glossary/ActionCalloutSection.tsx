...
export default function ActionCalloutSection() {
  const actions = [
    { label: "Find a Room", href: "/find-a-room/search-rooms", isPrimary: true },
    { label: "List a Room", href: "/list-a-room", isPrimary: false },
    { label: "Open Guides", href: "/resources/guides", isPrimary: false },
  ];
