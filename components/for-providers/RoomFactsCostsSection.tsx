      ...
      <Container>
        <Reveal className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <Eyebrow>Room Facts, Availability and Costs</Eyebrow>
            <SectionTitle>What must be accurate and current</SectionTitle>
          </div>
          ...
          <Callout label="Example boundary" className="max-w-3xl">
            Illustrative disclosure: $1,250/month rent, $1,250 deposit, $75 one-time move-in fee,
            bills estimated separately, known amount before move-in $2,575. These USD amounts show
