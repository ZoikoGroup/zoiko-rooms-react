      ...
      <Container>
        <Reveal className="flex flex-col gap-10">
          <div className="flex flex-col gap-4">
            <Eyebrow>Proof &amp; Procurement</Eyebrow>
            <SectionTitle>What a due-diligence or procurement reviewer can expect to see</SectionTitle>
          </div>
          ...
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <motion.div variants={fadeUp} className="w-full overflow-hidden rounded-2xl">
              <NaturalImage
                ...
                alt="A procurement reviewer meeting with an organization representative"
              />
            </motion.div>
