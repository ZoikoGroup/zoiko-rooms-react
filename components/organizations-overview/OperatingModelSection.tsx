      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-10">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 text-center">
            ...
            <SectionTitle>
              Refer, distribute, manage, allocate, subsidize, direct bill, or support —never assume.
            </SectionTitle>
            <Paragraph className="mx-auto text-center">
              The organization selects a governed relationship model. Zoiko Rooms then exposes
              only the inventory, people, decisions, payments, records, and actions permitted by
