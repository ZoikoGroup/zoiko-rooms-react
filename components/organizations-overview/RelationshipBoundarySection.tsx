        ...
        <Reveal>
          ...
          >
            ...
            <h2 className="font-heading text-2xl font-medium text-white sm:text-3xl">
              An organization relationship is scoped, not an endorsement.
            </h2>
            <p className="max-w-2xl text-sm leading-relaxed text-[#C6CCDE]">
              Referral, distribution, management, allocation, subsidy, direct billing,
              eligibility, decision authority, data access, and support each receive a separate
              current status, owner, evidence source, effective period, limitation, and dispute
              path.
            </p>
          </motion.div>
        </Reveal>
