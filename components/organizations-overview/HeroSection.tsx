        ...
        <Reveal className="grid grid-cols-1 items-center gap-10 rounded-3xl bg-white p-8 shadow-sm sm:p-10 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col gap-6">
            ...
            <motion.h1 variants={fadeUp} className="font-heading text-4xl font-bold text-brand-navy sm:text-[34px]">
              Coordinate room access, supply, funding, and support through clear organizational
              responsibility.
            </motion.h1>

            <Paragraph>
              Choose the pathway that matches your organization. Define who refers, supplies,
              manages, allocates, pays, decides, supports, and accesses data before any person or
              room enters the workflow.
            </Paragraph>
          ...
          >
            <NaturalImage
              ...
              alt="Housemates sharing a meal in a kitchen"
            />
          </motion.div>
        </Reveal>
      </Container>
