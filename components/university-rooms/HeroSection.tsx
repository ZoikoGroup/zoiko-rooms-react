        ...
        <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            <motion.p variants={fadeUp} className="max-w-lg text-[15px] leading-relaxed text-[#7A7266]">
              Search current room listings using institution, campus, move-in or term dates,
              monthly budget, stay length, commute, furnishing, bills, guarantor needs, and
            ...
            >
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="flex min-w-0 flex-col gap-1">
                  <span className="px-1 text-xs font-medium text-neutral-600">University or Campus</span>
                ...
                <div className="flex min-w-0 flex-col gap-1">
                  <span className="px-1 text-xs font-medium text-neutral-600">Move-in / Term</span>
                  <div className="flex h-10 items-center rounded-lg border border-[#E9E0D3] bg-white px-3">
                    <input
                      type="text"
                      placeholder="Date or term"
                      className="w-full min-w-0 bg-transparent text-sm text-brand-ink outline-none placeholder:text-neutral-400"
                    />
                  </div>
                </div>
          ...
          >
            <NaturalImage
              ...
              alt="Two students chatting in a furnished room near campus"
            />
          </motion.div>
        </Reveal>
      </Container>
