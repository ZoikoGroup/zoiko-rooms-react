      ...
      <Container>
        <Reveal className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <Eyebrow>{t("International Arrival Support")}</Eyebrow>
            <SectionTitle>{t("Uncertain dates, documents, or currency? Start here")}</SectionTitle>
          </div>

          <Callout label={t("Cross-border basics")} className="max-w-3xl">
            {t(
