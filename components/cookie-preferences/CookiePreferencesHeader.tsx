      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-3">
          ...
          <h2 className="text-sm sm:text-base font-bold text-[#101C33]">
            Choose how Zoiko Rooms uses optional technologies
          </h2>

          {/* Descriptive Body Text */}
          <p className="text-xs sm:text-sm text-[#5C5B57] font-normal leading-relaxed max-w-2xl">
            Essential technologies keep Zoiko Rooms secure and working. Optional
            technologies may support preferences, measurement, personalisation,
            advertising or external services. Your available controls depend on
            the rules that apply to your location and the technology&apos;s
            purpose.
          </p>
        </div>
        ...
        <div className="bg-[#E2F0E8] border border-[#C5E1D2] rounded-xl px-4 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-[#2D6A4F]">
              Privacy signal detected: Global Privacy Control
            </span>
          </div>
          <a
            href="#"
        ...
        <div className="pt-2 space-y-2">
          ...
          <p className="text-[11px] text-[#A39B8B] font-normal leading-relaxed">
            Changes below are not applied until you select &quot;Save
            preferences&quot;.
          </p>
        </div>
      </div>
