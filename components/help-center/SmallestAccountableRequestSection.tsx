      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col items-start text-left space-y-3 w-full">
          <h2 className="text-2xl lg:text-[28px] font-serif font-bold text-[#14213D] leading-tight max-w-2xl">
            {t("Still need help? Start the smallest accountable request.")}
          </h2>
          <p className="text-xs sm:text-sm text-[#555E68] leading-relaxed max-w-2xl font-normal">
            {t("Choose the issue and affected journey, review what will be shared, and attach only necessary evidence.")}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Find a Room">{t("Find a Room")}</option>
                    <option value="List a Room">{t("List a Room")}</option>
                    ...
                    <option value="Safety & Trust">{t("Safety & Trust")}</option>
                  </select>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Organization Participant">
                      {t("Organization Participant")}
                    </option>
                    <option value="Pro Operator">{t("Pro Operator")}</option>
                    <option value="Representative / Advocate">
                      {t("Representative / Advocate")}
                    </option>
                  </select>
                  <ChevronDown className="w-4 h-4 text-[#555E68] absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-[#EFEFEF] border border-[#E9E0D3] text-[#14213D] text-xs sm:text-sm font-medium rounded-xl py-3.5 pl-4 pr-10 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#1A2E6E]"
                  >
                    <option value="Cannot access">{t("Cannot access")}</option>
                    <option value="Delayed action">{t("Delayed action")}</option>
                    <option value="Incorrect information">
                      {t("Incorrect information")}
                    </option>
                    <option value="Security concerns">{t("Security concerns")}</option>
                  </select>
                  <ChevronDown className="w-4 h-4 text-[#555E68] absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                </div>
              </div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="High / Time-Sensitive">
                      {t("High / Time-Sensitive")}
                    </option>
                    <option value="Urgent Safety">{t("Urgent Safety")}</option>
                  </select>
                  <ChevronDown className="w-4 h-4 text-[#555E68] absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                </div>
              </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder={t("What happened, and what outcome are you looking for?")}
