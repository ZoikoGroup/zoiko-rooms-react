          ...
          >
            <div className="flex items-center gap-4 text-center sm:text-left">
              ...
              <div className="flex flex-col gap-1">
                <h3 className="font-heading text-lg font-medium text-brand-navy">Something feel off right now?</h3>
                <p className="max-w-md text-sm leading-relaxed text-neutral-600">
                  Payment redirection, credential requests, a false room, or an unsafe viewing —
                  this overrides normal browsing.
                </p>
              </div>
            </div>
