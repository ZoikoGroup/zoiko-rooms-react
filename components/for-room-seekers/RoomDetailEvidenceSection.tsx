      ...
      <Container>
        <Reveal className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <Eyebrow>{t("Room Detail and Evidence")}</Eyebrow>
            <SectionTitle>{t("What every room detail page must show you")}</SectionTitle>
          </div>
          ...
          <Callout label={t("Material information order")} className="max-w-3xl">
            {t(
              "Availability and total money appear before promotional copy. Provider type and authority status appear before message, viewing, application, agreement, or payment actions. Unknown or not provided is explicit — the interface never invents a favorable value.",
            )}
          </Callout>
