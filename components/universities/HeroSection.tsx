      ...
      <Container>
        <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            >
              Coordinate room access for university communities through clear eligibility,
              supply, funding, data, and support responsibilities.
            </motion.h1>
            <motion.p variants={fadeUp} className="max-w-lg text-[15px] leading-relaxed text-[#7A7266]">
              For students, staff and faculty, visiting academics, placements and internships,
              and international arrivals — one platform, with every responsibility named.
            </motion.p>
