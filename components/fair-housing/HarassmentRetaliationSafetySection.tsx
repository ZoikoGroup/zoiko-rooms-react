      ...
      <Container>
        <Reveal className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <Eyebrow>Harassment, Retaliation &amp; Safety</Eyebrow>
            <SectionTitle>You don&apos;t have to pick the &quot;correct&quot; legal category.</SectionTitle>
            <Paragraph>
              Discrimination often shows up as harassment or retaliation after a conversation,
              booking or tenancy is already underway. We route it correctly on your behalf.
            </Paragraph>
          </div>
            ...
            <div className="divide-y divide-[#E9E0D3] bg-white">
              {harassmentRouting.map((row) => (
                <div key={row.what} className="grid grid-cols-[1.6fr_1fr] items-center gap-4 px-6 py-3.5 text-sm">
                  ...
                  <span className="font-semibold text-brand-red">{row.where} →</span>
                </div>
              ))}
            </div>
          </motion.div>
