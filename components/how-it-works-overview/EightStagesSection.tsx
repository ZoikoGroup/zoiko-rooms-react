      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-10">
          <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
            <Eyebrow>The Eight Stages</Eyebrow>
            <SectionTitle>Every step, evidenced and explained</SectionTitle>
          </div>
            ...
            {stages.map(({ number, title, description, image }) => (
              ...
              >
                <div className="relative h-[130px] w-full overflow-hidden">
                  <ImageFade src={image} alt={title} fill sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" className="object-cover" />
                </div>
