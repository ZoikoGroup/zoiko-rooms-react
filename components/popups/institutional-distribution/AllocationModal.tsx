          ...
          <div className="p-5 sm:p-6 space-y-3.5">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-[#555E68] leading-relaxed">
                The institution assigns or proposes exact room capacity under
                declared rules.
              </p>
            </div>
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-[#555E68] leading-relaxed">
                Participants see the room, dates, costs, alternatives, and a
                clear acceptance/decline path with expiry.
              </p>
            </div>
            ...
            <div className="bg-[#FAF0D9] border border-[#F3E2B8] rounded-xl p-2.5 sm:p-3 flex items-start gap-2">
              ...
              <p className="text-[11px] sm:text-xs font-medium text-[#8A6A24] leading-relaxed">
                ...
                coercive acceptance and no suitability guarantee.
              </p>
            </div>
