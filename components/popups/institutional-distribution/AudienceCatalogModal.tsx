...
interface AudienceCatalogModalProps {
  isOpen: boolean;
  onClose: () => void;
  onTalkToZoiko?: () => void;
}
...
export default function AudienceCatalogModal({
  isOpen,
  onClose,
  onTalkToZoiko,
}: AudienceCatalogModalProps) {
          ...
          <div className="p-5 sm:p-6 space-y-3.5">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-[#555E68] leading-relaxed">
                The institution makes approved rooms visible to a defined cohort
                — a scoped window into current supply.
              </p>
            </div>
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-[#555E68] leading-relaxed">
                Participants browse scoped, current supply with the same
                evidence and cost transparency as the open marketplace.
              </p>
            </div>
            ...
            <div className="bg-[#FAF0D9] border border-[#F3E2B8] rounded-xl p-2.5 sm:p-3 flex items-start gap-2">
              ...
              <p className="text-[11px] sm:text-xs font-medium text-[#8A6A24] leading-relaxed">
                ...
                Catalog access is not eligibility, allocation, or funding —
                it&apos;s discovery only.
              </p>
            </div>
