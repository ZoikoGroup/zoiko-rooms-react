      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-8 text-center">
          <div className="flex max-w-2xl flex-col items-center gap-4">
            <Eyebrow>{t("Delegation Boundary")}</Eyebrow>
            <SectionTitle>{t("The full authority chain, always visible")}</SectionTitle>
            <Paragraph className="mx-auto">
              {t(
                "From client organization to participant, every link names who can search, decide, sign, and pay — and what happens when responsibility moves."
              )}
            </Paragraph>
          </div>
