      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-10">
          <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
            <Eyebrow>Supply &amp; Discovery</Eyebrow>
            <SectionTitle>Rooms connected to every move, evidence attached</SectionTitle>
            <Paragraph className="mx-auto">
              Every shortlist card carries provider authority, current availability, and complete
