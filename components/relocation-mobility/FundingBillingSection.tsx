      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-10">
          <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
            <Eyebrow>Funding, Fees &amp; Billing</Eyebrow>
            <SectionTitle>Complete costs before anyone commits</SectionTitle>
            <Paragraph className="mx-auto">
              Client-paid and participant-paid amounts, always shown side by side, in original
              currency — before an agreement is ever signed.
            </Paragraph>
          </div>
          ...
          <div className="grid w-full grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              <NaturalImage
                ...
                alt="Packing a suitcase and tablet ahead of a relocation move"
              />
            </motion.div>
