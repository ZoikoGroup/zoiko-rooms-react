      ...
      <Container>
        <Reveal className="flex flex-col items-center gap-10">
          <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
            <Eyebrow>Mobility Pathways</Eyebrow>
            <SectionTitle>Every move has its own shape</SectionTitle>
            <Paragraph className="mx-auto">
              From a domestic transfer to a household&apos;s international assignment, each
              pathway carries its own timing, funding, and boundaries.
            </Paragraph>
          </div>
