      ...
      <Container>
        <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            >
              {t("Find a room that fits where you are going, when you need it, and how you live.")}
            </motion.h1>
          ...
          <motion.div variants={fadeUp} className="w-full overflow-hidden rounded-4xl">
            <NaturalImage
              ...
              alt={t("Bright private room with plants, ready to search and book")}
            />
          </motion.div>
        </Reveal>
      </Container>
