...
const tags = ["Flexible dates", "Accessible home features", "Institution or employer"];
        ...
        <Reveal className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            <motion.p variants={fadeUp} className="max-w-lg text-[15px] leading-relaxed text-[#7A7266]">
              Search current room listings by location, move-in date, monthly budget, room type,
              household fit, accessibility, study, work, healthcare, or international-move needs.
            </motion.p>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="flex min-w-0 flex-col gap-1">
                  ...
                  <div className="flex h-10 items-center rounded-lg border border-[#E9E0D3] bg-white px-3">
                    <input
                      type="text"
                      placeholder="City, neighborhood, university"
                      className="w-full min-w-0 bg-transparent text-sm text-brand-ink outline-none placeholder:text-neutral-400"
                    />
                  </div>
                </div>
                <div className="flex min-w-0 flex-col gap-1">
                  <span className="px-1 text-xs font-medium text-neutral-600">Move-in</span>
                  <div className="flex h-10 items-center rounded-lg border border-[#E9E0D3] bg-white px-3">
                    <input
                      type="text"
                ...
                <div className="flex min-w-0 flex-col gap-1">
                  <span className="px-1 text-xs font-medium text-neutral-600">Monthly budget</span>
                  <div className="flex h-10 items-center rounded-lg border border-[#E9E0D3] bg-white px-3">
                    <input
                      type="text"
                      placeholder="Min – Max"
          ...
          <motion.div variants={fadeUp} className="w-full overflow-hidden rounded-4xl">
            <NaturalImage
              src="/images/find-a-room/hero-bedroom.png"
              alt="Bright private room with plants, ready to search and book"
            />
          </motion.div>
        </Reveal>
      </Container>
