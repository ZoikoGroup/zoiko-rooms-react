  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl sm:text-3xl font-serif font-normal flex items-baseline gap-2 mb-6">
        ...
        <span>Applications, viewings, offers &amp; agreements</span>
      </h2>
      ...
      <div className="bg-[#F2DED2] rounded-2xl px-4 py-3 mb-8">
        <p className="text-sm font-bold text-[#93321F] leading-relaxed">
          In short: the application and agreement process must use accurate
          information, and the resulting agreement is between you and the other
          party.
        </p>
      </div>
      ...
      <p className="text-sm sm:text-base text-[#5C5B57] font-normal leading-relaxed">
        Applications must contain lawful, accurate information. Viewings &mdash;
        in person or virtual &mdash; should be conducted respectfully and
        safely. An offer becomes binding only once accepted in the manner your
        Regional Schedule and the specific transaction require; a transaction
        snapshot capturing the terms you agreed to is retained and available to
        you.
      </p>
    </section>
  );
